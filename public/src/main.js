...
varhand = 0;  // the number of hands being tracked
var handX = 0;
var handY = 0;
var handZ = 0;
var sliderD;   // a slider for changing the size of the circle

var controller = Leap.loop({enableGestures: true}, function (frame) {
    hand = frame.hands.length;

    // Iterate over the frame.hands array and get the info of each hand object
    for (let i = 0; i < frame.hands.length; i++) {
        // Update the x, y, z positions of the first hand in the hands array
